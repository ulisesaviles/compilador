...
const rules: { [rule: string]: string[] } = {
  ...
  SWITCH_SENTENCE: [
    "SWITCH BRACES_OPEN CASES DEFAULT BRACES_OPEN BLOCK_OF_CODE BRACES_CLOSED",
  ...
  FOR_SENTENCE: [
    "FOR PARENTHESIS_OPEN DECLARATION COMMA BOOLEAN_VALUE COMMA NUM PARENTHESIS_CLOSED BRACES_OPEN BLOCK_OF_CODE BRACES_CLOSED",
  ],
};
